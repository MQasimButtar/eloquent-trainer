...
![alt text](https://img.shields.io/badge/tech-HTML%20%7C%20CSS%20%7C%20JS-blue)

![alt text](https://img.shields.io/badge/platform-Web%20%7C%20PWA-orange)
✨ Features
...
Open it directly in any modern browser (Chrome, Safari, Edge).
Note: For microphone access to work strictly correctly, some browsers require the file to be served over localhost or https. You can use a simple extension like "Live Server" in VS Code, or just drag and drop (Microphone permission policies vary by browser for local files).
Option 2: Deploy for Free (Recommended)
GitHub Pages: Upload index.html to a repository and enable GitHub Pages in Settings.
Netlify Drop: Drag and drop the file into Netlify Drop for an instant HTTPS link.
🔑 API Configuration
...
Host the file (using GitHub Pages or Netlify).
